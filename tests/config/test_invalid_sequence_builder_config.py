...
class TestInvalidSequenceBuilderConfig(unittest.TestCase):
    ...
    def test_overlap_ge_sequence_length_raises(self) -> None:
        """overlap >= sequence_length should raise ValueError from SequenceDatasetBuilder."""
        ...
        self.assertIn("overlap must be < sequence_length", str(ctx.exception))
