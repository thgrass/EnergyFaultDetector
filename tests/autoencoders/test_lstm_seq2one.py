...
from energy_fault_detector.autoencoders.lstm_seq2one_autoencoder import (
    LSTMSeq2OneAutoencoder,
)
from energy_fault_detector.data_splitting.sequence_dataset import SequenceDatasetBuilder


class TestLSTMSeq2OneAutoencoder(unittest.TestCase):
    """Unit tests for the LSTMSeq2OneAutoencoder."""
    ...
    def test_fit_and_predict_with_conditional_features(self) -> None:
        ...
        ae_cond = LSTMSeq2OneAutoencoder(
