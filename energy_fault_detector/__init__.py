...
# autoencoders
register(
    module_path="energy_fault_detector.autoencoders.MultilayerAutoencoder",
...
register(
    module_path="energy_fault_detector.autoencoders.ConditionalAE",
    class_type="autoencoder",
    class_names=[
        "ConditionalAE",
...
# scores
register(
    module_path="energy_fault_detector.anomaly_scores.MahalanobisScore",
    class_type="anomaly_score",
    class_names=["MahalanobisScore", "Mahalanobis", "mahalanobis"],
)
register(
    module_path="energy_fault_detector.anomaly_scores.RMSEScore",
    class_type="anomaly_score",
...
# threshold selectors
register(
    module_path="energy_fault_detector.threshold_selectors.FDRSelector",
    class_type="threshold_selector",
    class_names=["FDRSelector", "FDR_selector", "fdr_selector", "FDR", "fdr"],
)
register(
    module_path="energy_fault_detector.threshold_selectors.FbetaSelector",
    class_type="threshold_selector",
    class_names=["FbetaSelector", "Fbeta_selector", "fbeta_selector", "fbeta"],
)
register(
    module_path="energy_fault_detector.threshold_selectors.QuantileThresholdSelector",
    class_type="threshold_selector",
    class_names=["QuantileThresholdSelector", "quantile_selector", "quantile"],
)
register(
    module_path="energy_fault_detector.threshold_selectors.AdaptiveThresholdSelector",
    class_type="threshold_selector",
    class_names=[
...
# EXPERIMENTAL streaming imports - loaded lazily
try:
    from energy_fault_detector.streaming.stream_fault_detector import (
        StreamingFaultDetector,
    )
    from energy_fault_detector.streaming.data_stream import DataStream
except Exception:
    StreamingFaultDetector = None  # type: ignore
    DataStream = None  # type: ignore
...
__all__ = [
    ...
    # EXPERIMENTAL streaming exports
    "StreamingFaultDetector",
    "DataStream",
]
